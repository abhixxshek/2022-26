            ...
            <CardContent className="px-10 py-16">
              <div className="space-y-10">
                <Button 
                  ...
                  className="w-full bg-white/[0.05] border border-white/10 text-white hover:bg-white/[0.1] transition-all duration-300 rounded-full h-16 text-[10px] font-black uppercase tracking-[0.4em] group"
                >
                  <GoogleIcon />
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-[9px] uppercase font-black tracking-widest">
                    <span className="bg-[#050505] px-4 text-white/20">or use institutional credentials</span>
                  </div>
                </div>
